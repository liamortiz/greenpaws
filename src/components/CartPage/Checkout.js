    ...
    render() {
        return (
            <form onSubmit={this.props.placeOrder}>
                ...
                <label htmlFor="street">Apartment number (Optional)</label>
                ...
                <button className="icon remove" onClick={this.props.hideCheckout}></button>
                <button className="btn btn-checkout" type="submit">Place Order</button>
            </form>
        )
    }
}
