    ...
    render() {
        return (
            <div className="gallery-wrapper">
                <img className="slider" src={hero1} style={{transform: `translateX(${this.state.currentIndex}%)` }}/>
                <img className="slider" src={hero2} style={{transform: `translateX(${this.state.currentIndex}%)` }}/>
                <img className="slider" src={hero3} style={{transform: `translateX(${this.state.currentIndex}%)` }}/>
